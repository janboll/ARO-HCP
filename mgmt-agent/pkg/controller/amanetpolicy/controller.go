...
const (
	AMANetworkPolicyControllerName = "AMANetworkPolicy"
...
func (c *AMANetworkPolicyController) addFinalizer(ctx context.Context, hcp *hypershiftv1beta1.HostedControlPlane) error {
	...
	_, err := c.hsClient.HypershiftV1beta1().HostedControlPlanes(updated.Namespace).Update(ctx, updated, metav1.UpdateOptions{})
	return err
}
...
func (c *AMANetworkPolicyController) reconcile(ctx context.Context, hcp *hypershiftv1beta1.HostedControlPlane) error {
	...
	logger.Info("Reconciled AMA NetworkPolicy for HostedControlPlane")
	return nil
}
